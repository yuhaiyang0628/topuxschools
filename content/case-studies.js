// 每新增一个案例，复制一条对象并补齐字段即可。字段设计同时适用于网页和微信小程序。
window.CASE_STUDIES = [
  {
    ...
    admits: ["CMU MHCI", "UW HCDE"],
    result: "CMU MHCI 录取",
    year: "2025 Fall",
    tags: ["CMU", "DIY", "设计背景", "美国"],
  ...
  },
  {
    ...
    admits: ["RCA Service Design", "UAL Design Management"],
    result: "RCA Service Design 录取",
    year: "2025 Fall",
    tags: ["RCA", "工作经验", "服务设计", "英国"],
  ...
  },
  {
    ...
    admits: ["UCL HCI", "University of Edinburgh Design Informatics"],
    result: "UCL HCI 录取",
    year: "2025 Fall",
    tags: ["UCL", "转专业", "DIY", "英国"],
  ...
  },
  {
    ...
    admits: ["UW HCDE", "IIT Institute of Design"],
    result: "UW HCDE 录取",
    year: "2025 Fall",
    tags: ["UW", "产品经理", "跨学科", "美国"],
  ...
  },
  {
    ...
    admits: ["Aalto New Media", "Politecnico di Milano Communication Design"],
